...
export class CreateCall__Inputs {
  ...
  get poolParams(): CreateCallPoolParamsStruct {
    return this._call.inputValues[0].value.toTuple() as CreateCallPoolParamsStruct;
  }

  get settingsParams(): CreateCallSettingsParamsStruct {
    return this._call.inputValues[1].value.toTuple() as CreateCallSettingsParamsStruct;
  }

  get feesSettings(): CreateCallFeesSettingsStruct {
    return this._call.inputValues[2].value.toTuple() as CreateCallFeesSettingsStruct;
  }

  get joinParams(): CreateCallJoinParamsStruct {
    return this._call.inputValues[3].value.toTuple() as CreateCallJoinParamsStruct;
  }
