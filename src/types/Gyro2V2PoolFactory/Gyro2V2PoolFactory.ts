...
export class Gyro2V2PoolFactory extends ethereum.SmartContract {
  ...
  try_getCreationCodeContracts(): ethereum.CallResult<
    Gyro2V2PoolFactory__getCreationCodeContractsResult
  > {
    let result = super.tryCall(
      "getCreationCodeContracts",
      "getCreationCodeContracts():(address,address)",
...
export class CreateCall__Inputs {
  ...
  get capParams(): CreateCallCapParamsStruct {
    return this._call.inputValues[8].value.toTuple() as CreateCallCapParamsStruct;
  }
  ...
  get pauseParams(): CreateCallPauseParamsStruct {
    return this._call.inputValues[10].value.toTuple() as CreateCallPauseParamsStruct;
  }
}
