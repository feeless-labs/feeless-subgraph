...
export class ERC4626LinearPoolV3 extends ethereum.SmartContract {
  ...
  try_getPausedState(): ethereum.CallResult<
    ERC4626LinearPoolV3__getPausedStateResult
  > {
    let result = super.tryCall(
      "getPausedState",
      "getPausedState():(bool,uint256,uint256)",
...
export class ConstructorCall__Inputs {
  ...
  get args(): ConstructorCallArgsStruct {
    return this._call.inputValues[0].value.toTuple() as ConstructorCallArgsStruct;
  }
}
...
export class OnSwap1Call__Inputs {
  ...
  get request(): OnSwap1CallRequestStruct {
    return this._call.inputValues[0].value.toTuple() as OnSwap1CallRequestStruct;
  }
