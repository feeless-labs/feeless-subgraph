...
export function updatePoolLiquidity(poolId: string, block_number: BigInt, timestamp: BigInt): boolean {
  ...
  } else if (oldPoolLiquiditySansBPT !== null ) {
    liquidityChange = newPoolLiquiditySansBPT.minus(oldPoolLiquiditySansBPT);
  } else {
    // Handle the case where oldPoolLiquiditySansBPT is null or undefined
    liquidityChange = newPoolLiquiditySansBPT; // or any other appropriate default behavior
  }
